...
// $Id: main.php,v 1.10 2004/06/14 14:22:15 skalpa Exp $
//  ------------------------------------------------------------------------ //
...
if ('form' == $op) {
    ...
    $sort_select->addOptionArray(['uname' => _AM_UNAME, 'email' => _AM_EMAIL, 'last_login' => _AM_LASTLOGIN, 'user_regdate' => _AM_REGDATE, 'posts' => _AM_POSTS]);
...
if ('submit' == $op) {
    ...
    if (isset($_POST['user_mailok'])) {
        ...
        } elseif ('mailok' == $_POST['user_mailok']) {
    ...
    if (isset($_POST['user_type'])) {
        if ('inactv' == $_POST['user_type']) {
            $criteria->add(new Criteria('level', 0, '='));
        } elseif ('actv' == $_POST['user_type']) {
            $criteria->add(new Criteria('level', 0, '>'));
        } else {
            $criteria->add(new Criteria('level', 0, '>='));
        }
    ...
    if (0 == $total) {
		...
		<table width='100%' border='0' cellspacing='1' cellpadding='4' class='outer'><tr><th align='center'><input type='checkbox' name='memberslist_checkall' id='memberslist_checkall' onclick='xoopsCheckAll(\"memberslist\", \"memberslist_checkall\");'></th><th align='center'>"
             . _AM_AVATAR
             . "</th><th align='center'>"
             . _AM_UNAME
             . "</th><th align='center'>"
        ...
        foreach (array_keys($foundusers) as $j) {
            ...
            echo "<tr class='$class'><td align='center'><input type='checkbox' name='memberslist_id[]' id='memberslist_id[]' value='"
                 ...
                 . "'><input type='hidden' name='memberslist_uname["
                 . $foundusers[$j]->getVar('uid')
                 . "]' id='memberslist_uname[]' value='"
                 . $foundusers[$j]->getVar('uname')
                 . "'></td>";

            echo "<td>$fuser_avatar</td><td><a href='"
                 . XOOPS_URL
                 . '/userinfo.php?uid='
                 . $foundusers[$j]->getVar('uid')
                 . "'>"
                 ...
                 . '</a></td><td>'
                 . $fuser_name
                 . "</td><td align='center'><a href='mailto:"
        ...
        if ($group > 0) {
            ...
            $add2group = $memberHandler->getGroup($group);
